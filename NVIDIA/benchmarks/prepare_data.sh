...
# ssd and maskrcnn
# -----------------------------------------
./ssd/implementations/pytorch/download_dataset.sh ${DIR_ROOT}

# -----------------------------------------
# maskrcnn
# -----------------------------------------
./maskrcnn/implementations/download_weights.sh ${DIR_ROOT}
